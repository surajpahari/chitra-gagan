...
<body>
  ...
  <form action="<?php echo URLROOT; ?>/users/register" method="post">
    <div class="formContainer">
      ...
      <input type="text" placeholder="Enter First Name" name="First Name" value="<?php echo $data['fname'] ?>" required>

      <label for="Last  Name"><b>Last Name</b></label>
      <input type="text" placeholder="Enter Last Name" name="Last Name" value="<?php echo $data['lname'] ?>" required>
      ...
      <input type="password" placeholder="Confirm Password" name="Confirm Password" value="<?php echo $data['confirm_password'] ?>" required>
